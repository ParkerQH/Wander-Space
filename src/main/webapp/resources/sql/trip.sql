...
VALUES ('parker@parker.com', 'China', 'Chongqing', '아름다운 충칭의 야경을 사진에 담다.', 
...
-- Trip 2
INSERT INTO trip (t_email, t_country, t_region, t_title, t_content, t_mainPicture) 
VALUES ('parker@parker.com', 'China', 'Chengdu', '판다의 나라 청두로!!', 
...
-- Trip 3
INSERT INTO trip (t_email, t_country, t_region, t_title, t_content, t_mainPicture) 
VALUES ('qihuan@qihuan.com', 'Korea', 'Suwon', '수원스타필드 구경가기(+화성행궁)', 
...
-- Trip 4
INSERT INTO trip (t_email, t_country, t_region, t_title, t_content, t_mainPicture) 
VALUES ('qihuan@qihuan.com', 'Japan', 'Tokyo', '아사쿠사의 전통과 현대가 어우러진 매력적인 여행', 
        '최근 아사쿠사를 방문했어요. 아사쿠사는 전통적인 분위기와 현대적인 요소가 조화를 이루는 곳으로, 특히 센소지와 그 주변의 전통적인 시장들이 인상적이었어요. 낮에는 사람들로 북적이는 거리에서 쇼핑을 즐기고, 저녁에는 화려한 네온 불빛 아래에서 아름다운 야경을 감상할 수 있었어요. 아사쿠사의 특색 있는 음식들도 많이 경험했는데, 특히 전통적인 일본 스낵인 나베야키와 사케를 즐기며 일본의 문화를 만끽했답니다. 여행 중, 여러 각도에서 아사쿠사의 풍경을 담았던 사진들이 저에게 좋은 추억으로 남았어요.', 
        'Asakusa.jpg');
